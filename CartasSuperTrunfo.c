...
int main(){
    ...
    superpoder2 = (float) populacao2 + area2 + pib2 + (float) + (1 / pib_cap2);


    /*Comparação das cartas*/

    ResultadoArea = area1 > area2;
    ResultadoDen_Popul = den_popul1 > den_popul2;
    ResultadoPib = pib1 > pib2;
    ResultadoPib_Cap = pib_cap1 > pib_cap2;
    ResultadoPontoTuristico = pt1 > pt2;
